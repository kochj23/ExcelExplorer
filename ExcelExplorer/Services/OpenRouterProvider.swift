...
enum OpenRouterProvider {
    ...
    static let referer = "https://github.com/kochj23/ExcelExplorer"
    static let title = "ExcelExplorer"

    /// macOS Keychain service used to store the OpenRouter API key.
    static let keychainService = "com.jordankoch.excelexplorer.openrouter"
