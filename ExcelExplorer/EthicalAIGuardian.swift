        ...
        if let jsonData = response.data(using: .utf8),
           let json = try? JSONSerialization.jsonObject(with: jsonData) as? [String: Any] {
            ...
            let category: ViolationCategory = {
                ...
                case "deception", "fraud": return .fraud
            ...
            let action: EnforcementAction = {
                ...
                case "block_and_refer", "refer": return .blockAndRefer
                case "warn_user", "warn", "warn_and_log": return .warnAndLog
                case "require_approval", "approve", "require_acknowledgment": return .requireAcknowledgment
