...
//  ExcelExplorer
//
//  Ported verbatim from AIStudio (Jordan Koch, 2026-02-19). Defines the LLM
//  backend taxonomy used by the multi-model load balancer, including the
//  OpenRouter (frontier) and Nova Gateway backends.
//
